...
public class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        logger.fileLog(requestStartMessage);
        ...
        try {
            ...
            logger.fileLog("RESPONSE FAILED: " + request.url() + " " + e);
            throw e;
        }
            ...
            if (!logBody || response.body() == null) {
                ...
                if (contentType != null) {
                    try {
                        ...
                        logger.log("");
                        logger.log("Couldn't decode the response body; " +
        ...
        logger.fileLog("RESPONSE " + response.code() + ' '
                + response.request().url() + " (" + tookMs + "ms "
                + buffer.size() + " body" + ')' + " " + TimeUnit.NANOSECONDS.toMillis(startNs) + " "
                + TimeUnit.NANOSECONDS.toMillis(endNs));
